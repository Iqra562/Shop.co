...
// console.log(id)
    ...
    const newQuantity = existingItem ? existingItem.quantity + productQuantity : productQuantity
    console.log('existing item' ,newQuantity  )
    cartRequest({ productId: String(id), quantity: newQuantity },{
      onSuccess: () => {
    ...
    <section className="container    ">
      ...
      <div className="flex pt-10">
        <div className="w-8/12 border-r-2 pr-20">
          <div className=" h-[35rem]  rounded-md overflow-hidden">
            <img
        ...
        <div className="pl-8 space-y-14 w-5/12">
          ...
          <div>
           ...
           {showMaxQuantityError && <p className="text-red-500 text-sm mt-2">Limit reached: The maximum quantity per product is 15. You already  have {findProductInCart.quantity} units in your cart.</p>}
          </div>
          ...
          >
            {
              addToCartLoader ? (<Spin indicator={<LoadingOutlined  style={{ fontSize: 15, color: "white", marginRight:'10px' }} spin />} size="small  " colorPrimary='#000' dotSizeSM={50}  spinning={addToCartLoader}/>):'Add to cart'
            }

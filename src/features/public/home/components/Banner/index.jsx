            ...
            <div className="">
              <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-7 ">
                <div className="overflow-hidden rounded-xl  md:w-4/12">
                  <div className="mx-auto rounded-md  flex justify-center py-2 md:py-10 lg:py-12">
                ...
                <div className=" md:w-4/12 ">
                  <div className="overflow-hidden rounded-2xl h-[15rem] md:h-[18rem] lg:h-[26rem]  relative">
                    <img
                      ...
                      className="w-full h-full object-cover object-top "
                    />
                    <button className="bg-white z-10 absolute h-10  bottom-0 px-10 rounded-full text-center bg-opacity-80 backdrop:blur-3xl mx-auto left-0 right-0 w-8/12 md:w-11/12 xl:w-6/12 mb-5 font-bold">
                      Explore More
                    </button>
                  </div>
                </div>
